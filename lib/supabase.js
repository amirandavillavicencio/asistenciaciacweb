...
function createConfigError(endpointName, config) {
  ...
  error.details = {
    ...
    message:
      'Se requiere NEXT_PUBLIC_SUPABASE_URL y SUPABASE_SERVICE_ROLE_KEY para procesar la solicitud en backend.',
  };
  return error;
}
